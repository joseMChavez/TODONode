...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { TodoController } from './Application/controllers/todo/TodoController';
...
const models: TsoaRoute.Models = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Pick_ITodo._id-or-name-or-description-or-status_": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"_id":{"ref":"ObjectId","required":true},"name":{"dataType":"string","required":true},"description":{"dataType":"string","required":true},"status":{"dataType":"boolean","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "BodyTodo": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_ITodo._id-or-name-or-description-or-status_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Boolean": {
        "dataType": "refObject",
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/todos',
            ...
            function TodoController_GetAllTodo(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
                ...
                const contaiterService = Container.get(TodoService);
                const controller = new TodoController(contaiterService);


              const promise = controller.GetAllTodo.apply(controller, validatedArgs as any);
        ...
        app.post('/todos',
            ...
            function TodoController_PostTodo(request: any, response: any, next: any) {
            const args = {
                    _req: {"in":"body","name":"_req","required":true,"ref":"BodyTodo"},
            };
            ...
            try {
              ...
              const promise = controller.PostTodo.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.put('/todos',
            ...
            function TodoController_PutTodo(request: any, response: any, next: any) {
            const args = {
                    _req: {"in":"body","name":"_req","required":true,"ref":"BodyTodo"},
            };
            ...
            try {
              ...
              const promise = controller.PutTodo.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
